...
var _stylesSass = require("./styles.sass");
var _comparison = require("./js/comparison");
var _comparisonDefault = parcelHelpers.interopDefault(_comparison);
window.comparison = (0, _comparisonDefault.default);
(0, _comparisonDefault.default).init();

},{"./styles.sass":"jTRbH","./js/comparison":"bPXGl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jTRbH":[function() {},{}],"bPXGl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const mouseMoveHandler = (event)=>{
    ...
    if (!trackClicked) return;
    const delta = event.pageX - (appCoords.left + trackHalf);
    const value = delta < 0 ? 0 - trackHalf : delta > appCoords.width - $track.clientWidth ? appCoords.width - trackHalf : delta;
...
},{}]},["8TtF2","gLLPy"], "gLLPy", "parcelRequire6d62")
